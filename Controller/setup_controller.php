<?php
class SetupController extends ModNewslettersAppController {
	var $name = 'Setup';
	var $uses = array('ModuleConfig', 'ModNewsletters.NewslettersConfig'); // NewslettersConfig for validation ONLY
