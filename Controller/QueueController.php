<?php
class QueueController extends QuickLetterAppController {
    var $name = 'Queue';
    var $uses = array('QuickLetter.Queue', 'QuickLetter.Sending');
    var $components = array('QuickLetter.Newsletter');
    ...
    function beforeFilter() {
         ...
         */
        $t = time() - Configure::read('QuickLetter.settings.queue_timeout');
