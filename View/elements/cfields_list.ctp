						...
						<table width="100%" id="table_list" class="tablekit">
							<thead>
								<tr>
									...
									<th width="21%" align="left" class="text"><?php __e("Name"); ?></th>
									<th width="56%" align="left" class="text"><?php __e("Preview"); ?></th>
									<th width="15%" align="left" class="text"><?php __e("Belongs To"); ?></th>
									<th width="6%" align="center" class="<?php __e("date-iso"); //es: date-eu ?>"><?php __e("Order"); ?></th>
								</tr>
							</thead>
