    ...
    function start_inplace_editor() {
        $$('span.inPlaceEdit').each(function(e) {
            if (!e.hasClassName('__inplace_editor__')) {
                ...
                //okText: '<?php echo __t(('save'); ?>',
                //cancelText: '<?php echo __t(('cancel'); ?>',
                savingText: '<?php echo __t(('saving...'); ?>',
                clickToEditText:'<?php echo __t(('click to edit'); ?>',
