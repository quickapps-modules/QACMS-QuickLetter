<table width="100%" id="table_list" class="tablekit">
    <thead>
        <tr>
            ...
            <th width="24%" align="left" class="text"><?php echo __t(("Name"); ?></th>
            <th width="37%" align="left" class="email"><?php echo __t(("E-Mail Address"); ?></th>
            <th width="19%" align="left" class="text"><?php echo __t(("Lists"); ?></th>
            <th width="7%" align="center" class="text"><?php echo __t(("Status"); ?></th>
            <th width="11%" align="center"
                class="<?php echo __t(("date-iso"); //es: date-eu ?>"><?php echo __t(("Signup Date"); ?></th>
        </tr>
    </thead>
    ...
    <tbody>
        ...
        <tr
            ...
            <td align="center"><a
                href="<?php echo $html->url("/{$this->plugin}/users/edit/{$user['User']['id']}"); ?>"><?php e(date(__t('Y-m-d H:i:s'), strtotime($user['User']['created']))); ?></a></td>
        </tr>
        <?php
            }
        ...
        <tr>
            ...
            <?php echo __t(("You have no users."); ?><br />
            </td>
        </tr>
        <?php }?>
    </tbody>
    <tfoot>
        ...
        <tr>
            ...
            <form action="" method="post"><?php echo __t(("Rows per Page"); ?>:
