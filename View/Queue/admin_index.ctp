...
<h1 class="main-title"><?php echo __t(("Queue Manager"); ?></h1>


<div class="main">
<table width="100%">
    <tr>
        <td width="50%" align="left" valign="top"><b><?php echo __t(('With Selected'); ?>:</b>&nbsp;
            <span id="checkbox_actions">
                <select id="actions_select"    onChange="actions_select(this.value);">
                    ...
                    <option value="queue/delete" text="<?php echo __t(("Delete queue"); ?>"><?php echo __t(("Delete"); ?></option>
                </select>
            </span>
            <span id="radio_actions" style="display: none;">
                <select    id="actions_select"    onChange="radio_queue_actions_select(this.value);">
                    <option value="0"><?php echo __t(("Select Action"); ?></option>
                    <option value="resume"><?php echo __t(("Resume"); ?></option>
                    <option value="cancel"><?php echo __t(("Cancel"); ?></option>
                </select>
            </span>
        </td>
    </tr>
            ...
            <div class="dialogue-content" style="width: 600px">
                <div class="wrap">
                    <div id="queue_sending_dialogue_wrap">
                        <h1><?php echo __t(("Sending Queue"); ?></h1>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td colspan="2" align="left"><b><?php echo __t(("Logs"); ?></b></td>
                            </tr>
