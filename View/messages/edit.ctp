...
<h1 class="main-title"><?php __e("Editing Newsletter"); ?></h1>
...
<div align="center" class="centermain">
		<div id="tabs">
		<div class="tab"><a href="#"><?php __e('Quick Help'); ?></a></div>
		</div>
		<div class="module">
		<div class="module-head">&nbsp;</div>
		<div class="module-wrap">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td><?php __e('To send a message fill out the information. The minimum requirement for a valid message is the information in the "Newsletter\'s Content" tab. To finish your message and send it for real, choose the "Lists" tab, select your lists and click the button "Send Message to Selected Mailinglists"'); ?>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td><strong><?php __e('Placeholders'); ?>:</strong></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="left">
				<ul>
					<li>[WEBSITE] - <?php __e('the address you type for your website.'); ?></li>
					<li>[DOMAIN] - <?php __e('the text you type for your domain.'); ?></li>
					<li>[SUBSCRIBEURL] - <?php __e('the location of the subscribe page.'); ?></li>
					<li>[UNSUBSCRIBEURL] - <?php __e('the location of the unsubscribe page.'); ?></li>
					<li>[PREFERENCESURL] - <?php __e('he location of the page where users can update their details.'); ?></li>
					<li>[CONFIRMATIONURL] - <?php __e('the location of the page where users have to confirm their subscription.'); ?></li>
				</ul>
				<div class="radBttn" style="float: right;"><a href=""
					onClick="Effect.toggle('placeholders_list', 'blind', { duration: 0.2 }); return false;"><span><?php __e("+ More Placeholders"); ?></span></a></div>
				<br>
				...
				<ul>
					...
					<li style="list-style: none;">&nbsp;</li>
					<li style="list-style: none;"><strong><?php __e("Custom Placeholders"); ?>:</strong></li>
					<?php
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td align="left">
					...
					<br />
					<button class="primary_lg"	onClick="send_message('queue'); return false;"><?php __e('Send Message to Selected Mailinglists'); ?></button>
				</td>
			</tr>
		</table>
		</div>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<button class="primary_lg" onClick="send_message('test'); return false;"><?php __e('Send Test Message'); ?></button>
				</td>
			</tr>
		...
		<div class="dialogue-content" style="width: 670px">
			<div class="wrap">
				...
				<fieldset class="nopad">
					<button type="button" class="primary_lg right" onclick="Messaging.kill('message_edit_dialogue');"><?php __e("Close"); ?></button>
				</fieldset>
			</div>
		</div>
	</div>
	...
	<div class="dialogue">
		<div class="dialogue-content" style="width: 400px">
			<div class="wrap">
				...
				<fieldset class="nopad">
					<button type="button" class="primary_lg right" onclick="Messaging.kill('add_template_errors_dialogue');"><?php __e("Close"); ?></button>
				</fieldset>
			</div>
		</div>
	</div>
