...
<table width="100%" border="0" cellspacing="0" cellpadding="3"
    align="center">
    <tr>
        <td align="left"><b><?php echo __t(("Deleting List"); ?></b></td>
    </tr>
    <tr>
        <td align="left">
        <hr />
    ...
    <tr>
        <td align="left">
        <div style="padding: 15px;"><?php echo __t(("Please confirm that you wish to delete the following list"); ?>:</div>
        </td>
    </tr>
    ...
    <tr>
        ...
        <div style="margin: 15px 0 15px 0; padding: 15px;"><?php printf(__t("There are %s user residing under %s:"), count($listData['User']), $listData['Group']['name']); ?>
        <blockquote><input name="data[handle_users]" checked="checked"
            onClick="<?php echo ( $availables_lists > 0) ? "$('users_list_parent').hide();" : "" ; ?>"
            type="radio" value="delete">&nbsp;<?php echo __t(("<b>Delete</b> all subscribers residing in this list."); ?>
            <?php if ( count($availables_lists)-1 > 0) { ?> <br />
        <input name="data[handle_users]" value="move"
            onClick="$('users_list_parent').show();" type="radio">&nbsp;<?php echo __t(("<b>Move</b> all subscribers residing in this list."); ?><br />
        ...
        <span style="font-size: 10px;"><?php echo __t(("Unable to move users, as there are no other top level lists."); ?></span>
        <?php } ?></blockquote>
        </div>
        <?php } ?></td>
    </tr>
    <tr>
        ...
        <button class="primary_lg right"
            onClick="delete_group('deleteListForm'); return false;"><?php echo __t(("Confirm"); ?></button>
        </td>
    </tr>
</table>
</form>
