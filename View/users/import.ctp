...
<table width="100%">
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="5" cellpadding="0">
			<tr>
				<td colspan="2" align="left" valign="top"><b><?php __e("Imported Data Source"); ?></b></td>
				<td width="50%" align="left" valign="top"><b><?php __e("Imported Data Destination"); ?></b></td>
			</tr>
			<tr>
				<td colspan="2" align="left" valign="top"><input type="radio"
					name="data[Import][type]" id="type_csv" value="csv"
					onclick="$('div_type_csv').show(); $('div_type_text').hide();"> <?php __e("I would like to upload and import a Comma Separated Values (CSV) file."); ?><br />
				<input type="radio" name="data[Import][type]" id="type_text"
					value="text"
					onclick="$('div_type_csv').hide(); $('div_type_text').show();"> <?php __e("I would like to paste CSV data into a textarea to import."); ?><br />
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="33%" align="left" valign="middle"><b><?php __e("Select Your Local CSV File:"); ?></b></td>
					...
					<tr>
						<td colspan="2" align="left" valign="top"><b><?php __e("Important Notice:"); ?></b>
						<?php printf(_e("Please be aware that your server's maximum upload file size is set to %sB and that we suggest making your import files small than 1,000 rows at a time to prevent server timeouts."), ini_get('upload_max_filesize') ); ?>
						</td>
					</tr>
					<tr><td colspan="2">&nbsp;</td></tr>
				</table>
				...
				<div id="div_type_text" style="display: none;"><b><?php __e("Please Paste CSV Data Below:"); ?><b /><br />
				<textarea name="data[Import][csvtext]" rows="5" style="width: 99%;"></textarea></div>

				</td>
				<td align="left" valign="top"><?php __e("Please select the group or groups that you would like these importees subscribed to:"); ?><br />
			...
			<tr>
				<td width="15%" align="left" valign="top"><?php __e("Fields Delimited By"); ?>:</td>
				<td colspan="2" align="left" valign="top"><input
			...
			<tr>
				<td colspan="3" align="left" valign="top"><b><?php __e("Import Options"); ?></b></td>
			</tr>
			<tr>
				<td colspan="3" align="left" valign="top"><input type="checkbox"
					name="data[Import][options][firstrowfields]" value="1"
					checked="checked" />&nbsp;<?php __e("The first row in the file/data contains the field names; try to match those."); ?>
				</td>
			</tr>
			<tr>
				<td colspan="3" align="right" valign="top">
					<input type="button" onclick="import_csv('validate', 'prepare');" class="primary_lg" value="<?php __e("Select Fields »"); ?>">
				</td>
			</tr>
		</table>
...
<form method="post" enctype="multipart/form-data" style="display: none;">
	<div id="flashUI1" style="display: none;">
		<div>
			<input id="fsUploadCsvCancelBtn" type="button" class="primary_lg"	value="<?php __e("Stop Upload"); ?>" onClick="cancelQueue(swfu);" disabled="disabled" style="font-size: 8pt;" /> <br />
		</div>
	</div>
