...
<!--<h1 class="main-title"><?php __e('Editing User'); ?></h1>-->
			...
			<tr>
				<td width="50%" align="left" valign="top">
					<div align="center" class="centermain">
						<div id="tabs">
							<div class="tab"><a href="#"><?php __e("Basic User Data"); ?></a></div>
						</div>
								...
								<table width="100%" border="0" align="center" cellpadding="0"
									...
									<tr>
										...
										<button class="primary_lg"
											onclick="add_user('addUserForm'); return false;"><?php __e("Update User"); ?></button>
										</td>
									</tr>
								</table>
							</div>
				...
				<td width="50%" align="left" valign="top">
					<div align="center" class="centermain">
						<div id="tabs">
							<div class="tab"><a href="#"><?php __e('Groups'); ?></a></div>
						</div>
						...
						<div class="module">
							...
							<div class="module-wrap">
								<table width="100%" border="0" cellspacing="5" cellpadding="0">
									<tr>
										<td width="17%" align="left" valign="top"><b><?php __e("Subscriber List"); ?>:</b></td>
				...
				<div align="center" class="centermain">
					<div id="tabs">
						<div class="tab"><a href="#"><?php __e("Custom Fields"); ?></a></div>
					</div>
