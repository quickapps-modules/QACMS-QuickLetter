...
<div align="center" class="centermain">
        <div id="tabs">
          <div class="tab"><a href="#"><?php __e("Export Mailing List"); ?></a></div>
        </div>
        <div class="module">
         ...
         <div class="module-wrap">
				...
				<table width="100%" border="0" cellspacing="5" cellpadding="0">
				  ...
				  <tr>
					<td align="left" valign="top"><input name="data[Export][Fields][]" type="checkbox" id="id" value="id" checked="checked" onclick="alert('<?php __e('The subscriber id must be present in all exports, you cannot de-select this field.'); ?>'); return false" /> <b>id</b></td>
				  ...
				  <tr>
					...
					<input type="button" class="primary_lg" onclick="export_csv();" value="<?php __e("Export List"); ?>" />
					</td>
				  </tr>
				</table>            
