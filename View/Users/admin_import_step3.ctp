        ...
        <div align="center" class="centermain">
            ...
            <div class="module">
                <div class="module-head">&nbsp;</div>
                    ...
                    <br/>
                    <br/>
                        <input type="button" class="primary_lg right" onclick="import_csv('finish', 'redirect');" value="<?php echo __t(("Finish »"); ?>" />
                        <?php if (count($errors) > 0) { ?><input type="button" class="primary_lg right" onclick="window.location.href= base_url+'mod_newsletters/users/import/prepare';" value="<?php echo __t(("« Try Again"); ?>" /><?php } ?>
