...
<?php printf(echo __t(("Your Comma Separated Values (.csv) export file should begin downloading automatically; however, if it does not please click %s to download it."), "<a href=\"index.php?module=mod_8&view=users&act=download_exported_csv\">".echo __t(("<b>here</b>")."</a>"); ?>
</div>
<?php } else { ?>
...
<table width="100%" border="0" cellspacing="5" cellpadding="0">
    ...
    <tr>
        <td align="left" valign="top"><input name="export[standard][]"
            ...
            onclick="alert('<?php echo __t(("The subscriber id must be present in all exports, you cannot de-select this field."); ?>'); return false" />
        <b>id</b></td>
    ...
    <tr>
        <td colspan="3" align="right" valign="top"><input type="submit"
            value="<?php echo __t(("Export List"); ?>" /></td>
    </tr>
</table>
