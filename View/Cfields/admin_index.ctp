...
<h1 class="main-title"><?php echo __t(('Custom Fields'); ?></h1>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <select name="actions_select" id="actions_select" onChange="actions_select(this.value);">
                        ...
                        <option value="cfields/delete" text="<?php echo __t(("Delete custom fields and all related data"); ?>"><?php echo __t(("Delete"); ?></option>
                    </select>
                    </td>
                </tr>
                ...
                <tr>
                    <td align="left" valign="top">
                        ...
                        <br/>
                        <input type="button" onclick="reorder_cfieds();" class="primary_lg right" value="<?php echo __t(('Rorder'); ?>" />
