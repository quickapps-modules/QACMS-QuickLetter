      <div align="center" class="centermain">
        <div id="tabs">
          <div class="tab"><a href="#"><?php echo __t(("Editing Field") ?></a></div>
        </div>
        <div class="module">
          <div class="module-head">&nbsp;</div>
          <div class="module-wrap">
            <form method="post" id="cfieldForm" action="">
                <input name="data[Cfield][id]" type="hidden" value="<?php e($this->data['Cfield']['id']); ?>">
              <table width="100%" align="center" cellspacing="5">
                ...
                <tr id="foptions" style="<?php echo (  in_array($this->data['Cfield']['type'], array('hidden', 'select', 'radio', 'checkbox'))  ) ? '' : 'display:none;'; ?>">
                ...
                <tr>
                  ...
                  <td align="right" valign="middle">
                        ...
                        <input type="button" class="primary_lg right" value="<?php echo __t(("Update Field"); ?>" onclick="add_cfield(<?php echo $this->data['Cfield']['id'];?>);"  />
                  </td>
                </tr>
              </table>
            </form>
