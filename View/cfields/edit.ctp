      <div align="center" class="centermain">
        <div id="tabs">
          <div class="tab"><a href="#"><?php __e("Editing Field") ?></a></div>
        </div>
        <div class="module">
              ...
              <table width="100%" align="center" cellspacing="5">
                ...
                <tr>
                  ...
                  <td align="right" valign="middle">
                        ...
                        <input type="button" class="primary_lg right" value="<?php __e("Update Field"); ?>" onclick="add_cfield(<?php echo $this->data['Cfield']['id'];?>);"  />
                  </td>
                </tr>
              </table>
            </form>
